...
**Status:** kick-off. No experiments run yet.
**Started:** 2026-08-18.
...
|---|---|---|---|
| P0 | Data layer and event reconstruction | 2.83M timestamps decoded, sanity checks pass | not started |
| P1 | Rényi spectrum estimator | property checks + finite-sample bias control | not started |
